...
//     let liCreateForUl = document.createElement('li')
//     liCreateForUl.innerText = string
//     ulCreate.appendChild(liCreateForUl)
// }
...
//
//     let divMDandHR = document.createElement('div')
//     divMDandHR.classList.add('divMDandHR')
//
...
//     divHR.innerText = coursesArrayElement.hourDuration
//         divHR.classList.add('divHR')
//
//     let ulElement = document.createElement('ul')
//     ulElement.classList.add('ulModules')
//         ulElement.classList.add('ulElement')
//
//     for (const ulModule of coursesArrayElement.modules) {
//         let li = document.createElement('li');
//         li.innerText = ulModule
//         ulElement.appendChild(li)
//     }
//
//
//     divMDandHR.append(divMD, divHR)
//     div.append(divTitle, divMDandHR, ulElement)
// }